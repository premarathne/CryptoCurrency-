...
* We have 2000+ crypto coins inside our coinmarketcap plugin and grab data using coingecko.com API. You can show anything inside your crypto pricing table – marketcap, price, volume, changes, charts etc.
